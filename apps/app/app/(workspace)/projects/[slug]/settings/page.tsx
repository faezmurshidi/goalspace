  ...
  return (
    <div className="mx-auto w-full max-w-4xl px-6">
      <div className="flex flex-col gap-10 pb-10 pt-8">
        <h1 className="label border-rule text-ink-soft border-b pb-2">{t('app.settings.title')}</h1>
        ...
        <section className="border-rule flex flex-col gap-4 border-t pt-10">
          <h2 className="label border-rule text-ink-soft border-b pb-2">
          ...
          <dl className="flex flex-col gap-3">
            <div className="flex flex-wrap items-baseline justify-between gap-x-4 gap-y-1">
              ...
              <dd className="text-title text-ink tabular-nums">${monthToDateUsd.toFixed(2)}</dd>
            </div>

            <div className="flex flex-wrap items-baseline justify-between gap-x-4 gap-y-1">
              <dt className="text-body text-ink-soft">{t('app.settings.monthlyCap')}</dt>
              <dd className="text-title text-ink tabular-nums">
          ...
          <p className="text-micro text-ink-soft max-w-[65ch]">{t('app.settings.worstCaseNote')}</p>

          {!hasActiveAgents ? (
            <p role="status" className="text-body text-ink-soft max-w-[65ch]">
