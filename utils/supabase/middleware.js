...
function withAuth(handler) {
    ...
    return function (request) { return __awaiter(_this, void 0, void 0, function () {
        var cookieStore, supabase, _a, user, authError, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 2, , 3]);
                    cookieStore = (0, headers_1.cookies)();
                    supabase = (0, server_2.createClient)(cookieStore);
                ...
                case 1:
                    ...
                    return [2 /*return*/, handler(request, user, supabase)];
                case 2:
                    error_1 = _b.sent();
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    error_2 = _a.sent();
                    console.error('Error parsing request body:', error_2);
