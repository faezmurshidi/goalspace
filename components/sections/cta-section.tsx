            ...
            <div className="flex flex-col justify-center">
              ...
              >
                ...
                <p className="mb-8 text-lg text-muted-foreground">
                  Transform your goals into achievements with personalized AI mentorship and
                  structured learning paths.
                </p>
              ...
              >
                <div className="flex h-full flex-col items-center justify-center overflow-hidden rounded-xl border border-gray-200 bg-white p-8 shadow-sm dark:border-gray-800 dark:bg-gray-800">
                  ...
                  <div className="relative z-10 text-center">
                    ...
                    <p className="mb-5 text-sm text-muted-foreground">For a limited time only</p>
                    <div className="mb-5 flex justify-center">
                      <span className="bg-gradient-to-r from-primary to-primary/70 bg-clip-text text-5xl font-bold text-transparent">
                        50%
                      </span>
                      <span className="mb-1 ml-1 self-end text-xl"> OFF</span>
                    </div>
                    ...
                    <Button className="w-full rounded-lg bg-primary px-6 py-3 text-base font-medium text-white hover:bg-primary/90">
                      Claim Discount
                    </Button>
