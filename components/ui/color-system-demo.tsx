  ...
  const colorCategories: ColorCategory[] = [
    {
      ...
      colors: [
        ...
        },
        {
          ...
          className: 'bg-[hsl(var(--primary-muted))]',
      ...
      colors: [
        {
          ...
          textClass: 'text-foreground border border-border',
        },
        {
          name: 'Card',
          variable: '--card',
          className: 'bg-card',
          textClass: 'text-card-foreground border border-border',
        },
        {
          name: 'Popover',
          variable: '--popover',
          className: 'bg-popover',
          textClass: 'text-popover-foreground border border-border',
        },
      ],
    },
  ];
    ...
    <div className="w-full space-y-8 px-4 py-8">
      <div className="mb-12 text-center">
        ...
        <p className="text-lg text-muted-foreground">
          Our color system is designed for accessibility and visual harmony in both light and dark
          modes
        </p>
      </div>
      ...
      <div className="mt-12">
        ...
        <div className="grid gap-8 md:grid-cols-3">
          <div className="flex flex-col items-center gap-2">
            <div
              className="h-24 w-full rounded-lg bg-card p-4"
      ...
      <div className="relative mt-12 overflow-hidden rounded-xl p-8">
        ...
        <h3 className="relative z-10 mb-4 text-xl font-semibold">Glass Effect</h3>
        <div className="relative z-10 grid gap-6 sm:grid-cols-2">
          <div className="glass-effect rounded-lg p-6">
            <h4 className="mb-2 font-semibold">Glass Card</h4>
            <p className="text-sm text-muted-foreground">
              The glass-effect utility class adds a modern frosted glass appearance to elements.
            </p>
          </div>

          <div className="glass-effect rounded-lg p-6">
            <h4 className="mb-2 font-semibold">How to Use</h4>
            <div className="rounded bg-secondary/80 p-2 font-mono text-sm">
      ...
      <div className="mt-12 text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Use the &apos;gradient-text&apos; utility class for eye-catching headlines
        </p>
      </div>
    </div>
  );
